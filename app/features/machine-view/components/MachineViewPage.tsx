  ...
  return (
    <div className="min-h-screen bg-[#070a09] text-[#d7e0dc]">
      ...
      <a
        ...
        className="fixed left-4 top-3 z-[100] -translate-y-20 rounded-md bg-[#d7e0dc] px-3 py-2 text-sm font-semibold text-[#070a09] transition-transform focus:translate-y-0"
      >
        {locale === "nl" ? "Ga naar Markdown" : "Skip to Markdown"}
      </a>

      <header className="sticky top-0 z-50 border-b border-white/10 bg-[#070a09]/90 backdrop-blur-xl">
        <div className="mx-auto flex min-h-20 max-w-7xl flex-wrap items-center justify-between gap-x-8 gap-y-3 px-5 py-3 sm:px-8 lg:px-12">
          <div className="flex min-w-0 items-center gap-4">
            <Link
              href={humanHref}
              className="flex shrink-0 items-center gap-2.5 rounded-md focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#72e09a]"
            >
              <Image
            ...
            <a
              href={rawHref}
              className="hidden items-center gap-2 rounded-md font-mono text-xs text-white/50 transition-colors hover:text-white/80 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#72e09a] sm:inline-flex"
            >
          ...
          <div className="flex flex-wrap items-center justify-end gap-x-4 gap-y-2">
            <nav
              ...
              className="inline-flex min-h-11 items-center gap-1 font-mono text-[0.65rem] font-semibold uppercase tracking-[0.12em]"
            >
              <Link
      ...
      <main className="mx-auto max-w-7xl px-5 py-6 sm:px-8 sm:py-9 lg:px-12">
        <div className="mb-5 flex items-center justify-between gap-4 border-b border-white/10 pb-5">
          <div className="min-w-0">
            ...
            <p className="mt-1 font-mono text-[0.7rem] uppercase tracking-[0.14em] text-[#72e09a]">
              {labels.eyebrow}
            </p>
          </div>
          <a
            href={rawHref}
            className="shrink-0 font-mono text-xs text-white/40 underline decoration-white/20 underline-offset-4 transition-colors hover:text-white/75"
          >
            {labels.rawMarkdown}
          </a>
        </div>
        ...
        <pre
          ...
          className="m-0 whitespace-pre-wrap break-words font-mono text-[0.78rem] leading-6 text-[#c8d2ce] selection:bg-[#72e09a] selection:text-[#07110b] sm:text-[0.84rem] sm:leading-7"
        >
          {markdown}
        </pre>
      </main>
