...
export function TikTokIcon({ className }: IconProps) {
  return (
    <svg
      ...
      className={className}
    >
      <path d="M19.59 6.69a4.83 4.83 0 0 1-3.77-4.25V2h-3.45v13.67a2.89 2.89 0 0 1-5.2 1.74 2.89 2.89 0 0 1 2.31-4.64c.29-.02.57.02.84.1V9.4a6.84 6.84 0 0 0-1-.05A6.33 6.33 0 0 0 3.16 15.7a6.33 6.33 0 0 0 12.66 0V9.09a8.13 8.13 0 0 0 4.77 1.52V7.17a4.85 4.85 0 0 1-1-.48z" />
    </svg>
  );
}
