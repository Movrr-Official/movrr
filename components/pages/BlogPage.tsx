...
export function BlogPage({ copy }: { copy: BlogCopy }) { return <PageCopyProvider copy={copy}><main className="min-h-screen overflow-x-hidden bg-movrr-bg-canvas"><Navbar /><BlogMasthead /><BlogFeatured /><BlogGrid /><Footer cta={false} /></main></PageCopyProvider>; }
